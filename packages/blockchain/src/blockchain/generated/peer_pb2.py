...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_PREVOTEMESSAGE']._serialized_start = 349
    _globals['_PREVOTEMESSAGE']._serialized_end = 459
    _globals['_PRECOMMITMESSAGE']._serialized_start = 461
    _globals['_PRECOMMITMESSAGE']._serialized_end = 573
    _globals['_BLOCKREQUEST']._serialized_start = 575
    _globals['_BLOCKREQUEST']._serialized_end = 603
    _globals['_BLOCKRESPONSE']._serialized_start = 605
    _globals['_BLOCKRESPONSE']._serialized_end = 658
    _globals['_NETWORKADDRESS']._serialized_start = 660
    _globals['_NETWORKADDRESS']._serialized_end = 693
    _globals['_BLOCK']._serialized_start = 695
    _globals['_BLOCK']._serialized_end = 758
    _globals['_BLOCKHEADER']._serialized_start = 760
    _globals['_BLOCKHEADER']._serialized_end = 859
    _globals['_BLOCKBODY']._serialized_start = 861
    _globals['_BLOCKBODY']._serialized_end = 908
    _globals['_TRANSACTION']._serialized_start = 910
    _globals['_TRANSACTION']._serialized_end = 1025
    _globals['_TRANSACTIONDATA']._serialized_start = 1028
    _globals['_TRANSACTIONDATA']._serialized_end = 1169
    _globals['_UPDATETRANSACTION']._serialized_start = 1171
    _globals['_UPDATETRANSACTION']._serialized_end = 1255
    _globals['_REWARD']._serialized_start = 1257
    _globals['_REWARD']._serialized_end = 1300
    _globals['_COINBASETRANSACTION']._serialized_start = 1302
    _globals['_COINBASETRANSACTION']._serialized_end = 1349
    _globals['_STAKETRANSACTION']._serialized_start = 1351
    _globals['_STAKETRANSACTION']._serialized_end = 1387
    _globals['_STAKEADDRESS']._serialized_start = 1389
    _globals['_STAKEADDRESS']._serialized_end = 1438
    _globals['_VOTE']._serialized_start = 1440
    _globals['_VOTE']._serialized_end = 1481
    _globals['_NODE']._serialized_start = 1484
    _globals['_NODE']._serialized_end = 2102